...
"   -1 FLOAT, --alpha1=FLOAT    Increment del llindar de detecció 1 [default: 5]\n"
"   -2 FLOAT, --alpha2=FLOAT    Increment del llindar de detecció 2 [default: 5]\n"
...
DocoptArgs docopt(int argc, char *argv[], bool help, const char *version) {
    DocoptArgs args = {
        0, 0, 0, (char*) "5", (char*) "5", NULL, NULL, NULL,
